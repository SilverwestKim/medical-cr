rm(list=ls())
getwd()
setwd("C:/Users/eunse/Desktop/medical cr/Dbpia/투약오류_투약사고")

if(!require(dplyr)) install.packages("dplyr"); library(dplyr)
if(!require(rvest)) install.packages("rvest"); library(rvest)
if(!require(stringr)) install.packages("stringr"); library(stringr)

url="http://www.dbpia.co.kr/SearchResult/AdvancedSearch?AdvancedSearchType=TOTAL&Collection=0&SearchMethod=2&SearchOption=0&SearchKeyword=%ED%88%AC%EC%95%BD%EC%98%A4%EB%A5%98&SearchOper=2&SearchOption=0&SearchKeyword=%ED%88%AC%EC%95%BD%EC%82%AC%EA%B3%A0&category=002008&language=154001&PublishDate=4&PublishSttDate=2014&PublishEndDate=2018&SrvYN=Y"
x=read_html(url)
##################
index=c(4,5)
...
View(df)
write.csv(df,'투약오류_투약사고.csv',row.names=FALSE)
